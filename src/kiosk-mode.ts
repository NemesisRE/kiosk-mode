...
class KioskMode implements KioskModeRunner {
	...
	protected insertStyles() {
		...
		if (
			this.options[OPTION.HIDE_ADD_TO_HA] ||
			...
			this.options[OPTION.HIDE_ADD_DEVICE] ||
			this.options[OPTION.HIDE_CREATE_AUTOMATION] ||
			this.options[OPTION.HIDE_ADD_AREA] ||
			this.options[OPTION.HIDE_INVITE_PERSON] ||
			...
			const styles = [
				...
				this.options[OPTION.HIDE_ADD_DEVICE]
					&& STYLES.ADD_DEVICE,
				this.options[OPTION.HIDE_CREATE_AUTOMATION]
					&& STYLES.CREATE_AUTOMATION,
				this.options[OPTION.HIDE_ADD_AREA]
					&& STYLES.ADD_AREA,
				this.options[OPTION.HIDE_INVITE_PERSON]
					&& STYLES.INVITE_PERSON,
				this.options[OPTION.BLOCK_OVERFLOW]
			...
			if (queryString(SPECIAL_QUERY_PARAMS.CACHE)) {
				if (this.options[OPTION.HIDE_ADD_TO_HA])         setCache(TRUE, OPTION.HIDE_ADD_TO_HA);
				...
				if (this.options[OPTION.HIDE_ADD_DEVICE])        setCache(TRUE, OPTION.HIDE_ADD_DEVICE);
				if (this.options[OPTION.HIDE_CREATE_AUTOMATION]) setCache(TRUE, OPTION.HIDE_CREATE_AUTOMATION);
				if (this.options[OPTION.HIDE_ADD_AREA])          setCache(TRUE, OPTION.HIDE_ADD_AREA);
				if (this.options[OPTION.HIDE_INVITE_PERSON])     setCache(TRUE, OPTION.HIDE_INVITE_PERSON);
