...
|`hide_add_to_ha`                            | Boolean | false   | Hides the "Add to Home Assistant" overflow menu |
|`hide_add_device`                           | Boolean | false   | Hides the "Add device" button inside the "Add to Home Assistant" overflow menu |
|`hide_create_automation`                    | Boolean | false   | Hides the "Create automation" button inside the "Add to Home Assistant" overflow menu |
|`hide_add_area`                             | Boolean | false   | Hides the "Add area" button inside the "Add to Home Assistant" overflow menu |
|`hide_invite_person`                        | Boolean | false   | Hides the "Invite person" button inside the "Add to Home Assistant" overflow menu |
