...
|`hide_dialog_header_settings`<sup>2</sup> | Hides the "Settings" icon in the header of more-info dialogs. |
|`hide_dialog_header_overflow`<sup>2</sup> | Hides the top right overflow menu in the header of more-info dialogs. |
